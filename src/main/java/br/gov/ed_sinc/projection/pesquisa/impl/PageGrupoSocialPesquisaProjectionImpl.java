...
public class PageGrupoSocialPesquisaProjectionImpl implements PageGrupoSocialPesquisaProjection{
    private final Page<GenericoIdNomeDescricaoStatusProjection> page;

    public PageGrupoSocialPesquisaProjectionImpl(Page<GenericoIdNomeDescricaoStatusProjection> page) {
        this.page = page;
    }
