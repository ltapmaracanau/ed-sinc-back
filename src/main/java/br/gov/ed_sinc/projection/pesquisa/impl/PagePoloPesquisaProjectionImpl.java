...
public class PagePoloPesquisaProjectionImpl implements PagePoloPesquisaProjection{
    private final Page<GenericoIdNomeDescricaoStatusProjection> page;

    public PagePoloPesquisaProjectionImpl(Page<GenericoIdNomeDescricaoStatusProjection> page) {
        this.page = page;
    }
